...
enum network_event: uint64_t {
    NETWORK_EVENT_SPEED_DL = 1 << 0, /* download speed in bytes per second as u64 */
    NETWORK_EVENT_SPEED_UL = 1 << 1, /* upload speed in bytes per second as u64 */
    NETWORK_EVENT_CONNECTIONS = 1 << 2, /* number of active connections as u64 */
};
